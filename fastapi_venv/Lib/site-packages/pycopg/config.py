...
try:
    ...
    def load_dotenv(  # type: ignore[misc]  # fallback shape need not mirror python-dotenv's full stub (stream/verbose/interpolate/encoding) — genuinely unstubbed optional-dependency edge (D-01)
